...
public class ProjectileComponent : MonoBehaviour {
    ...
    private List<OnProjectileDestroyed> bulletDestroyedDelegates;
    ...
    private void Start(){
        ...
        if(TryGetComponent(out DamageableComponent damageable)){
            damageable.RegisterOnKilledDelegate(OnProjectileKilled);
        }
    }
    ...
    // is destroyed
    //##############################################################################################
    public void RegisterOnProjectileDestroyedDelegate(OnProjectileDestroyed d){
        if(bulletDestroyedDelegates == null){
            bulletDestroyedDelegates = new List<OnProjectileDestroyed>();
        }
    ...
    void FixedUpdate(){
        ...
        if(shouldKill){
            ...
            if(bulletDestroyedDelegates != null){
                foreach(OnProjectileDestroyed bulletDestroyedDelegate in bulletDestroyedDelegates){
    ...
    //##############################################################################################
    public void OnProjectileKilled(DamageableComponent damageable){
        shouldKill = true;
